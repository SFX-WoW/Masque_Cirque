...
**Masque: Cirque** is an add-on for [World of Warcraft](https://worldofwarcraft.com "World of Warcraft") that adds a set of skins for [Masque].
...
- **Cirque - Simple** - An alternate version of **Cirque** without an outer ring.
...
[SVG-Build]: https://img.shields.io/github/actions/workflow/status/SFX-WoW/Masque_Cirque/build-release.yml?label=Build&logo=github&logoColor=fff&style=flat-square
